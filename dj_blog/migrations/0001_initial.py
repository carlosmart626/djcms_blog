    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('block_header', simplemde.fields.SimpleMDEField(max_length=10000, blank=True, null=True)),
                ('block_footer', simplemde.fields.SimpleMDEField(max_length=10000, blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=15, db_index=True, choices=[('en', 'en'), ('es', 'es')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_title', simplemde.fields.SimpleMDEField(max_length=70, blank=True, null=True)),
                ('meta_description', simplemde.fields.SimpleMDEField(max_length=156, blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(max_length=140)),
                ('cover', models.ImageField(blank=True, null=True, upload_to='post_cover')),
                ('author', models.ForeignKey(to='djcms_blog.Author')),
                ('blog', models.ForeignKey(to='djcms_blog.Blog')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publisher_public', models.OneToOneField(null=True, editable=False, related_name='publisher_draft', to='djcms_blog.PostTitle')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
            fields=[
                ...
                ('slug', models.CharField(max_length=140)),
                ('color', models.CharField(max_length=14, choices=[('red', 'red'), ('orange', 'orange'), ('yellow', 'yellow'), ('olive', 'olive'), ('green', 'green'), ('teal', 'teal'), ('blue', 'blue'), ('violet', 'violet'), ('purple', 'purple'), ('pink', 'pink'), ('brown', 'brown'), ('grey', 'grey'), ('black', 'black')])),
                ('meta_title', simplemde.fields.SimpleMDEField(max_length=70, blank=True, null=True)),
                ('meta_description', simplemde.fields.SimpleMDEField(max_length=156, blank=True, null=True)),
                ('blog', models.ForeignKey(to='djcms_blog.Blog')),
            ],
        ...
        migrations.AlterUniqueTogether(
            name='blogtitle',
            unique_together=set([('blog', 'language')]),
        ),
    ]
